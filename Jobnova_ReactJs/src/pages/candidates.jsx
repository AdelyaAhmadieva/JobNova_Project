...
export default function Candidates(){
    ...
    async function getData(){
        var response = await axios.get("http://localhost:5259/candidates", {
            headers: {
                                    ...
                                    <div className="content">
                                        ...
                                        <div className="mt-2 d-flex align-items-center justify-content-between">
                                            <div className="text-right d-flex align-items-center gap-2">
                                                <p className="text-muted fw-medium mb-0">Name:</p>
                                                <p className="mb-0 fw-medium">{item.candidateName}</p>
                                            </div>
                                        ...
                                        <div className="mt-3">
                                            <Link to={`/candidate-profile/:${item.userId}`} className="btn btn-sm btn-primary me-1">View Profile</Link>
